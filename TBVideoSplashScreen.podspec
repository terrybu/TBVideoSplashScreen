#
#  Be sure to run `pod spec lint TBVideoSplashScreen.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://github.com/terrybu/TBVideoSplashScreen"
  ...
  # Or just: s.author    = "Terry Bu"
  # s.authors            = { "Terry Bu" => "burea1124@gmail.com" }
  # s.social_media_url   = "http://twitter.com/burownrice"
  ...
  s.source       = { :git => "https://github.com/terrybu/TBVideoSplashScreen.git", :tag => s.version }
...
#  s.source_files  = "Classes", "Classes/**/*.{h,m}"
  s.source_files = "TBVideoSplashScreen/*.swift"
